...
export const metadata: Metadata = {
  title: 'Alien Dawn - A Modern Platformer for Adults',
  description: 'Experience a platformer that understands you. Compelling characters with morally gray aspects, diverse backstories, and unique personalities affecting gameplay.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
